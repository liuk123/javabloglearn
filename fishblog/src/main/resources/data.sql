...
insert into b_article (create_time, update_time, content, desc, title, user_id) values (now(), now(), '文章内容123', '文章描述123', '文章标题1', 1L);
insert into b_article (create_time, update_time, content, desc, title, user_id) values (now(), now(), '文章内容123', '文章描述123', '文章标题2', 1L);
insert into b_article (create_time, update_time, content, desc, title, user_id) values (now(), now(), '文章内容123', '文章描述123', '文章标题3', 1L);
insert into b_article (create_time, update_time, content, desc, title, user_id) values (now(), now(), '文章内容123', '文章描述123', '文章标题4', 1L);
--
