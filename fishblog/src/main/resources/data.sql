...
--
-- insert into b_comment (create_time, update_time, article_id, from_user_id, content) values (now(), now(), 1L, 1L, '评论内容1');
-- insert into b_comment (create_time, update_time, article_id, from_user_id, content) values (now(), now(), 1L, 1L, '评论内容2');
-- insert into b_comment (create_time, update_time, article_id, from_user_id, content) values (now(), now(), 1L, 1L, '评论内容3');
--
